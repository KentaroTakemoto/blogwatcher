...
if __name__ == '__main__':
  ...
  parser.add_argument('--weight1', '-w1', default="/home/ppdev/data/weights/test4/chainer_refinenet_tmp.weight", type=str)
  ...
  import pickle
  with open('/home/ppdev/codes/blogwatcher/github/chainer_refinenet/results/test4_tmp.pickle', 'wb') as f:
